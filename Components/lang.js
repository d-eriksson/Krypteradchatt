...
export function buildTerms(){
  setTerms("en", {
      ...
      "To create a chat with your friend!" : "To create a chat with your firend!",
  ...
  setTerms("sv", {
      ...
      "To create a chat with your friend!" : "För att skapa en chatt med din vän",
      "Have a friend scan your QR-code" : "Låt en vän skanna din QR-kod",
      "And bob's your uncle!" : "Och sen är saken klar!",
